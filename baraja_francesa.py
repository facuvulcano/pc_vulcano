...
def main():#funcion principal, lo mas abstracto
    print('bienvenido al juego')
    user_value = input('presiona ENTER para seguir o \'q\'para salir')
...
def throw_card():
    ...
    #generar la carta (su string representacion)
...
def get_symbol_str(symbol_number: int) -> str:
    """ Mapea un numero int (entre 1 y 4) al caracter del simbolo de la carta """
    symbol = None
    if symbol_number == 1:
        symbol = chr(9824)
...
def get_value_str(value_number: int) -> str:
    """ mapea un numero inr (entre 1 y 13) al caracter del valor de la carta """
